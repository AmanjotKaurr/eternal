      ...
      <div className="min-h-screen w-[80%] border border-white/15 rounded-md m-8 mx-auto p-10">
        ...
        <div className="max-h-[80vh] w-[80%] mx-auto bg-gray-500/30 border-white/15 rounded-md mt-6 p-10 mb-0">
          ...
          <div className="h-[10%] w-[90%] mt-10">
            ...
            <Input className="py-6 mt-2" type="number" placeholder="Enter amount" />
          </div>
          ...
          <button className="w-[90%] bg-gray-600 mt-8 h-[5vh] rounded-md text-white/25">Create Switch</button>
        </div>
        ...
        <div className="flex gap-3 mx-auto w-[80%] mt-4">
            <button className="px-[15%] py-2 bg-red-400 text-white font-bold rounded-md">15s Escrow for testing</button>
            <button className="px-[15%] py-2 bg-red-400 text-white font-bold rounded-md">30s Escrow for testing</button>
        </div>
