      ...
      <div className="z-10 min-h-[10vh] w-screen p-1 pb-0 text-white backdrop-filter backdrop-blur-xs overflow-x-hidden">
        <div className="h-[10vh] flex items-center justify-between px-20 py-10">
          <Link href='/' className="flex items-center gap-5">
            <h1 className={`text-6xl text-cyan-400 ${roadRage.className}`}>WillyFi</h1>
          </Link>

          <div className="flex gap-8 ml-5">
                <Link href={'/will/claim'} className={`text-3xl ${michroma.className}`}>Claim</Link>
                <Link href={'/will/invest'} className={`text-3xl ${michroma.className}`}>Invest</Link>
            </div>
